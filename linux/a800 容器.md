...
```shell
nerdctl run -d --gpus=all -v /mnt/lustre/share/test-train:/mnt/lustre/share/test-train --network=host --shm-size="8g" --name=zkyg registry.sensetime.com/parrots-os/pytorch-cuda-cudnn:v1.5.1 /bin/bash -c "while true; do echo hello world; sleep 1;done"
```
