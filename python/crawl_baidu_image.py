# -*- coding: utf-8 -*-
"""
 @File    : crawl_baidu_image.py
 @Time    : 2019/11/12 下午2:35
 @Author  : yizuotian
 @Description    :
"""
...
# 将图片的content写入文件
def save_pic(root, url_real, content):
    path = os.path.join(root, url_real.split('/')[-1])
...
def main():
    ...
    for i in range(depth):
        ...
        for real_url in real_urls:
            ...
            save_pic(root, real_url, content)
